...
**Revision and environment:** Uncommitted implementation working tree based on Git `3a41cd8ca6835c619dbfbc94c1c960ff3ba62050`; macOS arm64; SDK `10.0.302`; ASP.NET runtime `10.0.10`. Execution ran from `2026-09-08T13:05:35Z` through `2026-09-08T13:27:53Z` (22 minutes 18 seconds), within the 30-minute allowance. Package pins are `Microsoft.AspNetCore.Mvc.Testing` `10.0.10`, `Microsoft.NET.Test.Sdk` `18.0.1`, and `MSTest.TestFramework`/`MSTest.TestAdapter` `4.0.2`; both project lock files are included implementation artifacts.
