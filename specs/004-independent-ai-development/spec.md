...
Select BI-004 only. The [backlog](../../docs/08-backlogs/M004-independent-ai-development.md#1-outcome-and-authoritative-inputs) records the inspected Git baseline, dependency evidence and source revisions. Apply workflow #0 v1.7, architecture #3 v1.10, AI #4 v1.4, verification/roadmap #6/#7 v1.7 and ADR-012; PRD/UX/API decisions remain unchanged.
