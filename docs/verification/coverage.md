...
This is the sole cross-document product coverage matrix; the source documents retain their behavioral acceptance IDs. Active product rows remain **Unselected / Pending** except for the explicitly linked, passing M005–M025 portions below; no narrow allocation satisfies a complete product requirement or release gate. Separately identified milestone rows link completed packages. Once product work is selected, link its actual #8 backlog/package and state partial coverage honestly. Deferred, retired and proposed rows are intentionally not current test gaps or passing gates. Design references plus Section 8.2 connect product rows to local scenario checks without copying their full acceptance prose.

Roadmap allocation is not evidence: implemented M028 owns the first complete Translation UI outcome and candidate M029 owns the first complete Rewriting UI outcome, with M030–M032 extending cross-feature recovery/lifecycle behavior and M038/M039 extending release browser/accessibility evidence. Their minimum functional proof is defined in [verification plan Section 4.5](../06-verification-plan.md#45-required-user-visible-transformation-evidence): dedicated DB-seeded verified user, at least one real login-form E2E path, a constrained real-auth fixture for other cases, and published in-browser outcome assertions for every UI-facing feature. Rows remain Unselected / Pending until a #8 package is selected and actual evidence is linked.
...
| FR-003 | UX §3; API §2 | V-003, V-009, V-012 | Candidate allocation: M026/M028 Translation and M027/M029 Rewriting; [M026 AC-001](../08-backlogs/M026/spec.md#acceptance) translation-operation portion (distinct translation execution path with its own success envelope; rewriting still pending) → Passed; [M028 AC-001/002](../08-backlogs/M028/spec.md#acceptance) translation-page portion (guarded `/translate` workspace with explicit activation, selectors, editable/copyable result, authoritative usage; `/rewrite` stays placeholder) → Passed |
...
| FR-011 | UX §6–7; AI §4; API §6 | V-002, V-003, V-007, V-010, V-012 | [M016 AC-002/004](../08-backlogs/M016/spec.md#acceptance) complete validated plain-text result portion (single transformation dispatch, terminal recorded failure, no auto-submit/fallback in this slice) → Passed (development evidence); [M026 AC-001/002](../08-backlogs/M026/spec.md#acceptance) translation-API portion (one explicit submit executes once through the real pipeline with complete validated text or a classified failure; no time/typing-triggered dispatch) → Passed (fake-provider evidence); [M028 AC-001/002](../08-backlogs/M028/spec.md#acceptance) explicit UI activation/result-handling portion (one browser activation, stale/edit guards, outdated marking) → Passed (published deterministic-provider evidence) |
...
| FR-016 | UX §6/8; API §5 | V-002, V-003, V-010, V-012 | Candidate M029 owns the explicit Rewrite UI outcome; Unselected → Pending |
| FR-017 | UX §6/8 | V-002, V-003, V-010 | Candidate M029 owns source preservation in the Rewrite UI; Unselected → Pending |
| FR-018 | UX §6/8; API §6 | V-002, V-003, V-005, V-010 | Candidate M029 owns first-result protection and M030 extends competing-event coverage; Unselected → Pending |
...
| FR-022 | UX §6/8 | V-002, V-003, V-010 | Candidate M029 owns the first Rewrite replacement behavior and M030 extends competing-event coverage; Unselected → Pending |
| FR-023 | UX §6/8 | V-002, V-003, V-010 | [M028 AC-004](../08-backlogs/M028/spec.md#acceptance) translation edit/copy portion (manual edits uncharged, exact-value copy, pending-response protection, later-submission replacement) → Passed (published evidence); M029 owns rewriting results; M030 extends edit-race coverage |
...
| FR-035 | API §2/5/9 | V-009, V-005 | [M026 AC-001/008](../08-backlogs/M026/spec.md#acceptance) translation portion (translation exposed as a distinct operation with its own success envelope and no sentence-alternative placeholders) → Passed; rewriting stays with M027 |
| FR-036 | API §2–3/7 | V-004, V-009, V-005 | [BI-005](../08-backlogs/M005/backlog.md) → [AC-001–006](../08-backlogs/M005/spec.md#4-selected-acceptance) public choices/limits and generated-type portion and [M009 / BI-009](../08-backlogs/M009/backlog.md) → [AC-001–007](../08-backlogs/M009/spec.md#acceptance) bearer auth portion → Passed; language/usage independence remains unselected; [M026 AC-001/007](../08-backlogs/M026/spec.md#acceptance) translation-independence portion (a separate verified Bearer [REDACTED] translates and reads usage without SPA execution) → Passed; rewriting stays with M027 |
| FR-037 | API §8; AI §7; UX §6/9 | V-009, V-003, V-004, V-005, V-007 | [M026 AC-002/003/005/007](../08-backlogs/M026/spec.md#acceptance) translation portion (400/422/429/503/504 categories with recovery guidance, distinguished from successful output) → Passed; rewriting stays with M027 |
...
| NFR-002 | PRD §7; AI §6; API §6 | V-014, V-007, V-005 | [M018 AC-004/006](../08-backlogs/M018/spec.md#acceptance) original-deadline enforcement portion (captured once, no-fit refusal, cancellation fencing, fake-time proof, live per-case timings) → Passed (development evidence; percentile/load measurement stays with V-014); [M026 AC-005/006](../08-backlogs/M026/spec.md#acceptance) API-deadline portion (stored absolute deadline enforced with fake time, 5 s/10 s/2 s stage budgets, deadline-exceeded 504 with zero charge, late success fenced) → Passed (fake-provider evidence) |
| NFR-003 | UX §6; architecture §7; API §5–7 | V-002, V-005, V-007, V-010, V-016 | Unselected → Pending |
| NFR-004 | UX §3; architecture §6; AI §8; API §9 | V-015, V-010, V-005 | [M007 AC-002/004/006](../08-backlogs/M007/spec.md#acceptance) account-secret/no-store slice → Passed; [M026 AC-008](../08-backlogs/M026/spec.md#acceptance) translation-execution portion (no source/result text, global counts, monetary values, credentials or provider internals in problems/logs/traces/TEXT columns; no-store on text-bearing responses) → Passed; remaining lifecycle, browser and operation persistence coverage unselected |
| NFR-005 | UX §4–5/10 | V-003, V-010, V-011 | [M028](../08-backlogs/M028/tasks.md#completion-record) translation component/browser foundation portion (semantic locators, heading focus, live regions, keyboard-operable controls in Chromium) → Passed; rewriting foundation stays with M029; M038/M039 plus successors own the release matrix |
...
| RG-001 | PRD §8; active functional rows above | V-001, V-002, V-003, V-004, V-005, V-007, V-009, V-010, V-012 | [M028](../08-backlogs/M028/tasks.md#completion-record) establishes the translation UI operation → Passed (published evidence); rewriting (M029), M030–M032 and other active rows still complete the gate |
...
| RG-006 | UX §10; Section 4 | V-010, V-011 | Functional UI prerequisite: [M028](../08-backlogs/M028/tasks.md#completion-record) translation portion met; rewriting prerequisite stays with M029; browser/device/AT evidence: M038/M039 plus successors |
...
| API-AC-004 | V-005; M021 AC-001/AC-004/AC-006 passed the admission portion (one reservation for concurrent identical claims, shared user/global ceilings with 429 categories and no overrun, restart-preserved reservation/revision); M022 AC-001/AC-003/AC-004 passed the settlement portion (one charge for settled success with idempotent duplicates, fenced late cross-outcome attempts with post-settlement 409, one consumed entry for 8 parallel settlements); M025 AC-005 passed the post-midnight reuse portion (same-payload resubmission/status returns the stored admission day with a fresh new-day snapshot and no ledger change, changed payload still 409); M026 AC-001/004 passed the translation-execution portion (synchronous 201 success with complete validated text, one admission-day charge and fresh snapshot; same-payload replay returns succeeded/output-unavailable metadata with no new dispatch or charge, changed payload still 409) |
| API-AC-005 | V-001, V-005; M021 AC-002/AC-003/AC-005/AC-007 passed the admission/matching portion (changed-payload 409, equivalent-spelling match, 24h/5min-skew expiry and 410-after-cleanup, pre-admission rejection matrix, metadata-only records); M026 AC-002/004 passed the translation validation/matching portion (malformed/unknown/duplicate/invalid-Unicode/unsupported/missing-target/equal-selection/empty/oversized rejected with zero dispatch and no admitted operation; duplicate/conflict semantics preserved through execution) |
| API-AC-006 | V-005, V-009, V-015; M022 AC-007 passed the succeeded/failed terminal-read portion (original charge metadata with output unavailable, fresh usage, unknown stays 404 without asserting zero charge); M024 AC-001/AC-004 passed the interrupted/success-wins portion (restart-reconciled interrupted metadata with zero charge and fresh usage, aborted wait committing success with output unavailable and the original charge); M025 AC-006 passed the cross-midnight terminal-read portion (interrupted/failed status across midnight reports zero charge with the original admission day and a fresh current-day snapshot); M026 AC-001/006 passed the translation terminal-read portion (settled translation success/failure survives restart with output unavailable and the original charge, unknown stays 404 asserting nothing) |
| API-AC-007 | V-005, V-016; M022 AC-002/AC-005/AC-006 passed the failure-window portion (failure releases with zero charge, cross-midnight success charges the admission day, restart-preserved settlement/revision with fenced late attempts and zero-dispatch reads); M024 AC-001/AC-002/AC-003/AC-005/AC-007 passed the interruption portion (pre-commit crash reconciled as interrupted after restart with zero charge and released reservation, deadline-passed scan with unexpired pending untouched, idempotent/fenced repeats, unknown 404 asserting nothing with expired 410 and malformed 400, same-file restart preserving interrupted state/ledgers/revision with post-restart fencing and side-effect-free reads); M025 AC-002/AC-007 passed the cross-period portion (post-midnight success charges the admission day with the new day untouched, two-process restart preserving both days' ledgers/revision/availability with byte-identical side-effect-free reads); M026 AC-005/006 passed the translation failure-window portion (fault/deadline/budget exhaustion settles failure with zero charge and released monetary exposure, late success fenced as deadline failure, status/usage reads never dispatch) |
| API-AC-008 | V-005, V-014; M024 AC-004 passed the disconnect/abort portion (aborted wait still commits success within the original deadline with succeeded/output-unavailable status; late output never revives terminal interrupted or failed records; status reads never dispatch work); M026 AC-001/006 passed the translation dispatch-free-read portion (status/usage reads never dispatch provider work after translation execution; unknown stays 404) |
| API-AC-009 | V-005, V-002, V-003; M025 AC-002 passed the cross-midnight portion (post-midnight success settles on the stored admission day with the new day untouched, status returns the admission day with a fresh new-day snapshot and stale-charge disclosure); M026 AC-007 passed the translation allowance portion (exhausted user allowance denied with 429 user/global distinction and reset guidance; snapshot/availability behavior unchanged) |
| API-AC-010 | V-006; M023 AC-001–008 passed the monetary-ceiling portion (per-attempt conservative bound reserved against the configured cap with 503 monetary-suspension denial and no writes, unknown/unbounded ineligible, 8 parallel admissions committing within the cap, settle-once/release with missing-evidence retention, cross-month carryover with original-month settlement attribution, restart-preserved ledgers with duplicate observation, amount-free logs/problems/TEXT columns, zero contract drift); M025 AC-003 passed the usage-composition portion (prior-month unresolved exposure denies new-month paid admission with monetary-suspended availability until authoritative settlement, settle-once attribution stays in the original month, known+unresolved totals prove no double counting); M026 AC-005 passed the per-dispatch admission portion (each translation dispatch admitted against the cap with 503 monetary-suspension denial and no writes on denial, missing configuration suspends dispatch, admitted exposure released on authoritative fake no-charge evidence) |
| API-AC-011 | V-005, V-002, V-003; M025 AC-001/AC-004 passed the snapshot portion (authoritative current-day snapshot with the five-state availability signal incl. unavailable mapping, day-first/revision-second ordering with exact JSON round-trip, monotonic revision across admission/settlement/recovery/restarts, no cross-account comparison); M026 AC-001 passed the translation-response snapshot portion (synchronous success and classified failures carry a fresh current-day snapshot) |
...
| API-AC-013 | V-009; M026 AC-001–008 passed the translation portion (a verified Bearer [REDACTED] translates through the real host/accounting pipeline with a fake provider: 201 complete text or classified 422/429/503/504 failure, exactly-once admission-day charge, bounded fallback/deadline/monetary admission, fenced recovery with dispatch-free reads; rewriting and browser journeys remain unselected) |
| API-AC-014 | V-009; M005 capability, M006 registration, M007 verification, M008 browser-session and M009 bearer contract-generation portions passed; M026 AC-008 passed the translation-delta portion (TranslationSuccessResponse with 201/504 responses, zero drift, no text/secrets in problems/logs/TEXT columns, no-store on every response) |
