...
| --- | --- | --- | --- |
| FR-001 | UX §9; API §3 | V-004, V-003, V-010 | [M006 / BI-006](../08-backlogs/M006/backlog.md) registration portion, [M008 / BI-008](../08-backlogs/M008/backlog.md) → [AC-001–008](../08-backlogs/M008/spec.md#acceptance) cookie sign-in/session/sign-out portion and [M009 / BI-009](../08-backlogs/M009/backlog.md) → [AC-001–007](../08-backlogs/M009/spec.md#acceptance) bearer sign-in portion → Passed; [M010 / BI-010](../08-backlogs/M010/backlog.md) API reset implemented with substitute behavioral evidence, focused/aggregate gates pending (see [tasks](../08-backlogs/M010/tasks.md#completion-record)); browser flow remains unselected |
| FR-002 | UX §9; API §3 | V-004, V-003, V-016 | [M006 / BI-006](../08-backlogs/M006/backlog.md) durable unverified/delivery-intent portion, [M007 / BI-007](../08-backlogs/M007/backlog.md) confirmation/resend portion and [M008 / BI-008](../08-backlogs/M008/backlog.md) unverified-session/current-state portion → Passed; [M010 / BI-010](../08-backlogs/M010/backlog.md) → [AC-001–006](../08-backlogs/M010/spec.md#acceptance) API reset implemented with substitute behavioral evidence, focused/aggregate gates pending (see [tasks](../08-backlogs/M010/tasks.md#completion-record)); browser journey and real email remain unselected |
