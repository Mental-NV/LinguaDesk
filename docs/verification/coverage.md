...
| API-AC-006 | V-005, V-009, V-015; M022 AC-007 passed the succeeded/failed terminal-read portion (original charge metadata with output unavailable, fresh usage, unknown stays 404 without asserting zero charge); M024 AC-001/AC-004 passed the interrupted/success-wins portion (restart-reconciled interrupted metadata with zero charge and fresh usage, aborted wait committing success with output unavailable and the original charge) |
