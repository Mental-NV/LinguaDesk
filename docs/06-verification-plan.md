...
**Document:** #6 · **Version:** 1.8 · **Status:** Verification design specified; M001–M004 enabling evidence passed; product/release evidence pending
**Updated:** 2026-09-09
...
The [M001 / package 001](../specs/001-backend-foundation/spec.md) backend host, [M002 / package 002](../specs/002-published-web-shell/spec.md) published signed-out shell, [M003 / package 003](../specs/003-durable-storage-foundation/spec.md) durable-storage foundation and [M004 / package 004](../specs/004-independent-ai-development/spec.md) offline AI boundary are implemented. M004 passed V-007's selected independent build, shared prompt-inspection and scripted-client portions with 10 focused cases and retained host/published regressions; its [completion record](../specs/004-independent-ai-development/tasks.md#3-completion-record) identifies the exact commands, reports and limitations. There is still no account/editor product capability, eligibility parser/decision, corpus, generated OpenAPI, provider evidence or passing release evidence. Names outside completed enabling packages below identify planned checks, not necessarily existing commands or files. Document review cannot discharge a release gate.
