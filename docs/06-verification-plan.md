...
**Document:** #6 · **Version:** 1.6 · **Status:** Verification design specified; M001–M003 enabling evidence passed; product/release evidence pending
**Updated:** 2026-09-09
...
The [M001 / package 001](../specs/001-backend-foundation/spec.md) backend host, [M002 / package 002](../specs/002-published-web-shell/spec.md) published signed-out shell and [M003 / package 003](../specs/003-durable-storage-foundation/spec.md) durable-storage foundation are implemented. Their selected enabling portions passed as recorded in the [M003 package evidence](../specs/003-durable-storage-foundation/tasks.md#3-completion-record), including fresh/repeated migrations, model drift, file-backed transactions/locking, same-file restart and retained host/published regressions. There is still no account/editor product capability, corpus, generated OpenAPI or passing release evidence. Names outside completed enabling packages below identify planned checks, not necessarily existing commands or files. Document review cannot discharge a release gate.
