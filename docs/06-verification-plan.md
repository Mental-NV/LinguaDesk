...
**Document:** #6 · **Version:** 1.7 · **Status:** Verification design specified; M001–M003 evidence passed; M004 selected; product/release evidence pending
**Updated:** 2026-09-09
...
The [M001 / package 001](../specs/001-backend-foundation/spec.md) backend host, [M002 / package 002](../specs/002-published-web-shell/spec.md) published signed-out shell and [M003 / package 003](../specs/003-durable-storage-foundation/spec.md) durable-storage foundation are implemented. Their selected enabling portions passed as recorded in the [M003 package evidence](../specs/003-durable-storage-foundation/tasks.md#3-completion-record), including fresh/repeated migrations, model drift, file-backed transactions/locking, same-file restart and retained host/published regressions. [M004 / package 004](../specs/004-independent-ai-development/spec.md) is selected for V-007's independent build, shared prompt-inspection and scripted-client portions; its runtime evidence is pending. There is still no account/editor product capability, corpus, generated OpenAPI or passing release evidence. Names outside completed enabling packages below identify planned checks, not necessarily existing commands or files. Document review cannot discharge a release gate.
...
| FR-004 | UX §6–8; AI §3; API §4 | V-001, V-002, V-003, V-007, V-013 | Unselected → Pending |
| FR-005 | AI §3; UX §7–8 | V-007, V-013, V-003 | Unselected → Pending |
| FR-006 | AI §3; UX §7–8 | V-007, V-013, V-003 | Unselected → Pending |
| FR-007 | API §4; UX §7–8 | V-001, V-002, V-003 | Unselected → Pending |
| FR-008 | AI §3–4; UX §7–8 | V-007, V-013, V-010 | Unselected → Pending |
| FR-009 | AI §3; UX §7; API §2 | V-013, V-003, V-009 | Unselected → Pending |
...
| FR-012 | AI §3; UX §8 | V-013, V-003, V-009 | Unselected → Pending |
| FR-013 | AI §3–4; UX §8 | V-013, V-007, V-003 | Unselected → Pending |
| FR-014 | UX §8; AI §3; API §4 | V-002, V-003, V-007, V-013 | Unselected → Pending |
...
| FR-036 | API §2–3/7 | V-004, V-009, V-005 | Unselected → Pending |
...
| Q-003/Q-006 | Selected wire DTOs/headers/operations, antiforgery bootstrap, password/token/email policy and delivery details resolved before their handlers/clients; generated contract review follows early implementation |
| Q-004 | Remaining account/deletion, backup/aggregate/unresolved-exposure retention and reconciliation rules; prove text lifecycle and restart/restore against them |
...
**Authoring validation:** Requirement/scenario inventory, local links, fixture counts and corpus/workload arithmetic are document checks. No runtime, live-provider, performance, browser, accessibility or release gate is reported passed. Technical source references above were checked on 2026-09-08; they support tool capabilities, while corpus sizes, sampling and workloads are this project's selected verification design.
