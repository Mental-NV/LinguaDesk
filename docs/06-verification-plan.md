...
**Document:** #6 · **Version:** 1.5 · **Status:** Verification design specified; M001/M002 enabling evidence passed; product/release evidence pending
**Updated:** 2026-09-09
...
The [M001 / package 001](../specs/001-backend-foundation/spec.md) backend-enabling host and [M002 / package 002](../specs/002-published-web-shell/spec.md) published signed-out shell are implemented. Their scoped V-003/V-009/V-010/V-011/V-012 portions passed as recorded in the [M002 package evidence](../specs/002-published-web-shell/tasks.md#3-completion-record). [M003 / package 003](../specs/003-durable-storage-foundation/spec.md) is selected for storage enablement with runtime evidence pending. There is still no account/editor product capability, corpus, generated OpenAPI or passing release evidence. Names outside completed enabling packages below identify planned checks, not necessarily existing commands or files. Document review cannot discharge a release gate.
...
| M003 / BI-003 — enabling scope | Architecture §4.1/5.2/6.1; explicit initialization and clean-restart persistence; no account/ledger or full product acceptance claimed | V-016 fresh migrations/model drift; V-005 file-backed transaction/restart foundation only; V-009/V-012 host/published regressions | [BI-003](08-backlogs/M003-durable-storage-foundation.md) → [package AC-001–006](../specs/003-durable-storage-foundation/spec.md#3-selected-acceptance) → [tasks/evidence](../specs/003-durable-storage-foundation/tasks.md#3-completion-record); Selected / Pending — no run |
