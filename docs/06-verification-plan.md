...
| Q-003/Q-006 | M005 resolves its public capability/count fields and pre-release artifact mechanics; later selected wire DTOs/headers/operations, antiforgery bootstrap, password/token/email policy and delivery details remain due before their handlers/clients; generated review precedes dependent client adoption |
