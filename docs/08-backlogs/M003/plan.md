...
**Inputs:** [spec.md](spec.md) v1.1; [BI-003](backlog.md) v1.1
...
[#6](../../06-verification-plan.md) remains the strategy/evidence-matrix owner. Add focused tests to the existing MSTest project, using real file-backed SQLite and the production context/migrations. Do not mock DbSet or use EF InMemory/SQLite in-memory to claim durability.
