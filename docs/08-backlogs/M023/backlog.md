...
| --- | --- | --- | --- | --- | --- |
| BI-023 | Every paid attempt reserves finite monetary exposure against a configured monthly ceiling before any dispatch; denied capacity, unknown spend and reconciliation cannot bypass the ceiling | Must | M021 Done (atomic admission, UTC-day ledgers, identity rules); M022 Done (deterministic settlement, conditional transitions, restart fencing) | implemented | [spec](spec.md) |
