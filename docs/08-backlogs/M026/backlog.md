...
| --- | --- | --- | --- | --- | --- |
| BI-026 | An independent verified client explicitly translates through the real host/accounting pipeline with a fake provider and receives complete output or a classified failure | Must | M009, M016, M018, M022, M023, M024, M025 (all Done, evidence in delivery/current.md); no blockers | implemented | [spec](spec.md) |
