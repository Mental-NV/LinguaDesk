...
| --- | --- | --- | --- | --- | --- |
| BI-024 | A client can inspect its original operation after disconnect/restart without regeneration, lost-charge claims or a late result reviving failure | Must | M022 Done (conditional settlement, fencing, restart durability); M023 Done (cost admission, exposure retention on missing evidence) | implemented | [spec](spec.md) |
