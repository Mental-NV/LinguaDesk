...
| --- | --- | --- | --- | --- | --- |
| BI-014 | A user can complete the forgot/reset-password forms and explicitly return to sign-in; failures and focus are understandable. | Selected web-access increment | M013 done; M010 done; no blocker; evidence complete, see [tasks](tasks.md#completion-record) | done | [spec](spec.md) |
