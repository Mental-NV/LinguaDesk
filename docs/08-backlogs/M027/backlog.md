...
| --- | --- | --- | --- | --- | --- |
| BI-027 | An independent verified client explicitly rewrites with a selected mode through the real host/accounting pipeline with a fake provider and receives complete output or a classified failure | Must | M026, M017 (both Done, evidence in delivery/current.md); no blockers | implemented | [spec](spec.md) |
