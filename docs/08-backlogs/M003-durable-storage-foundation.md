...
No planned end-of-milestone human action exists. Unexpected nonblocking human follow-up follows [#0](../00-SDD-Planning-Workflow.md#selecting-work-and-creating-a-package): prepare concrete instructions and report pending evidence at the end; if no safe independent work remains, report the real blocker. Existing authorization is sufficient for ordinary setup.
