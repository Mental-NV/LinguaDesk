...
| --- | --- | --- | --- | --- | --- |
| BI-008 | A local account can establish, inspect and end a secure browser cookie session through a generated API contract, with antiforgery on cookie mutations and immediate rejection after session invalidation. | Selected local-access increment | M007 done; no readiness blocker | selected | [spec](spec.md) |
