...
**Inputs:** [spec.md](spec.md) v1.1; [BI-004](backlog.md) v1.1
...
[#6](../../06-verification-plan.md) remains the strategy and matrix owner. Implement the selected V-007 portions with MSTest and noninteractive commands:
