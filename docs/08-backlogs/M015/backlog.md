...
Status: done; deterministic eligibility gates plus the bounded reviewed live slice passed (see [tasks](tasks.md#completion-record))
...
| --- | --- | --- | --- | --- | --- |
| BI-015 | Shared pipeline validates language eligibility deterministically and on a bounded live slice, rejecting ineligible input without transformation | P1 | M004 done, M005 done, M019 done; owner credential staged (M019 evidence) | done | [spec](spec.md) |
