...
| --- | --- | --- | --- | --- | --- |
| BI-012 | An unverified user can understand verification status, resend and explicitly continue after verification using the specified link variants. | Selected web-access increment | M011 done; M007 done; no blocker | done | [spec](spec.md) |
