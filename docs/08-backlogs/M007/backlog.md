...
| --- | --- | --- | --- | --- | --- |
| BI-007 | An unverified local account can confirm its email through deterministic delivery material, or request another link after a failed, invalid, or expired one, without account enumeration or authentication side effects. | Selected local-access increment | M006 done; no readiness blocker | selected | [spec](spec.md) |
