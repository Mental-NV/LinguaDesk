...
public sealed class ServingRewritingClientProvider : IRewritingClientProvider, IDisposable
{
    ...
    public ServingRewritingClientProvider(IOptions<ServingOptions> options, IConfiguration configuration)
        : this(options, configuration, SharedHttpClient)
    {
    }

    internal ServingRewritingClientProvider(IOptions<ServingOptions> options, IConfiguration configuration, HttpClient httpClient)
    {
